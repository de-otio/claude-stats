...
| `context`      | How much of the bill is carrying context forward, and where does it concentrate — over time, not at an instant. Includes a range recommendation for `/autocompact`'s window size |
